...
````yaml /api-reference/openapi.json patch /api/v2/trading/demo/positions/{positionId}
openapi: 3.0.1
info:
  title: eToro Api
  version: v1.279.0
...
paths:
  /api/v2/trading/demo/positions/{positionId}:
    patch:
      ...
      operationId: updateDemoPosition
      parameters:
        - name: x-request-id
          in: header
          required: true
          schema:
            type: string
            format: uuid
            example: df8e6102-98ca-4469-a4f3-b61135483eb1
