...
````yaml /api-reference/openapi.json delete /api/v2/trading/execution/demo/orders/{orderId}
openapi: 3.0.1
info:
  title: eToro Api
  version: v1.279.0
      ...
      parameters:
        - name: x-request-id
          ...
          schema:
            type: string
            format: uuid
            example: b1201f56-1d75-4ef4-9501-e64f5928586c
