...
Retrieves the demo account's current portfolio, including credit, open positions, orders, mirrors, and PnL details.



## OpenAPI

````yaml /api-reference/openapi.json get /api/v1/trading/info/demo/pnl
openapi: 3.0.1
info:
  title: eToro Api
  version: v1.279.0
    ...
    get:
      ...
      description: >-
        **Rate limit:** 60 requests per 60 seconds. This is a **dedicated**
        ...
        Retrieves the demo account's current portfolio, including credit, open
      ...
      parameters:
        - name: x-request-id
          ...
          schema:
            type: string
            format: uuid
            example: 1fe27c13-e554-4ded-a88b-65901677500e
      ...
      responses:
        '200':
          description: Successfully retrieved demo account PnL and portfolio information.
          content:
            application/json:
              schema:
