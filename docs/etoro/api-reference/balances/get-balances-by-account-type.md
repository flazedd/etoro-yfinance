...
Returns balances for a specific account type for the authenticated user. Optionally filter by account IDs.



## OpenAPI

````yaml /api-reference/openapi.json get /api/v1/balances/{accountType}
openapi: 3.0.1
info:
  title: eToro Api
  version: v1.279.0
    ...
    get:
      ...
      description: >-
        **Rate limit:** 60 requests per 60 seconds. This is the **default shared
        ...
        Returns balances for a specific account type for the authenticated user.
      ...
      parameters:
        - name: x-request-id
          ...
          schema:
            type: string
            format: uuid
            example: bb67d7fd-d5b3-46d6-82c9-03d06acacb98
