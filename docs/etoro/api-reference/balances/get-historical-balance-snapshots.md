...
````yaml /api-reference/openapi.json get /api/v1/balances/history
openapi: 3.0.1
info:
  title: eToro Api
  version: v1.279.0
    ...
    get:
      ...
      description: >-
        **Rate limit:** 60 requests per 60 seconds. This is the **default shared
        ...
        Returns end-of-day balance snapshots across all account types for the
      ...
      parameters:
        - name: x-request-id
          ...
          schema:
            type: string
            format: uuid
            example: ffaecc23-24b7-487a-8886-fcbbd1b1a01d
