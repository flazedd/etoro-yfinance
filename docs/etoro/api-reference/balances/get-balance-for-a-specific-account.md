...
Returns the balance for a specific account identified by type and account ID for the authenticated user.



## OpenAPI

````yaml /api-reference/openapi.json get /api/v1/balances/{accountType}/{accountId}
openapi: 3.0.1
info:
  title: eToro Api
  version: v1.279.0
    ...
    get:
      ...
      description: >-
        **Rate limit:** 60 requests per 60 seconds. This is the **default shared
        ...
        Returns the balance for a specific account identified by type and
      ...
      parameters:
        - name: x-request-id
          ...
          schema:
            type: string
            format: uuid
            example: f44c274e-a1d6-4bfe-8eed-0e814b7ed9c4
