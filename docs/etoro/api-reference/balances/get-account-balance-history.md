...
Returns end-of-day balance snapshots for a specific account identified by type and account ID for the authenticated user. History is available for the last 12 months. The maximum date range per request is 365 days.



## OpenAPI

````yaml /api-reference/openapi.json get /api/v1/balances/{accountType}/{accountId}/history
openapi: 3.0.1
info:
  title: eToro Api
  version: v1.279.0
    ...
    get:
      ...
      description: >-
        **Rate limit:** 60 requests per 60 seconds. This is the **default shared
        ...
        Returns end-of-day balance snapshots for a specific account identified
        by type and account ID for the authenticated user. History is available
        for the last 12 months. The maximum date range per request is 365 days.
      ...
      parameters:
        - name: x-request-id
          ...
          schema:
            type: string
            format: uuid
            example: 4424121a-f591-4523-9c21-f974a7f8c619
      ...
      responses:
        '200':
          description: >-
            Historical balance snapshots for the specified account retrieved
            successfully.
          content:
            application/json:
              schema:
        ...
        '404':
          description: >-
            Not Found — no account or historical data found for the specified
            parameters.
        '429':
