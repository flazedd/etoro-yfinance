...
````yaml /api-reference/openapi.json get /api/v1/trading/info/trade/history
openapi: 3.0.1
info:
  title: eToro Api
  version: v1.279.0
...
paths:
  /api/v1/trading/info/trade/history:
    get:
      ...
      operationId: getTradingInfoTradeHistory
      parameters:
        - name: x-request-id
          in: header
          required: true
          schema:
            type: string
            format: uuid
            example: bc698915-55e2-41a9-a448-1b04c121b85a
