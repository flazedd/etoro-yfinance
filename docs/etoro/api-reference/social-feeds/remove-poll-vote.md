...
Removes the authenticated user's vote from a specific poll option.



## OpenAPI

````yaml /api-reference/openapi.json delete /api/v1/posts/{postId}/polls/{pollId}/options/{optionId}/votes
openapi: 3.0.1
info:
  title: eToro Api
  version: v1.279.0
    ...
    delete:
      ...
      description: >-
        **Rate limit:** 60 requests per 60 seconds. This is the **default shared
        ...
        Removes the authenticated user's vote from a specific poll option.
      operationId: deletePostsByPostIdPollsByPollIdOptionsByOptionIdVotes
      parameters:
        - name: x-request-id
          in: header
          required: true
          schema:
            type: string
            format: uuid
            example: e9a82ea0-df18-4a46-8e4c-46e02c90f221
        ...
        - name: optionId
          in: path
          required: true
          description: ID of the option to unvote
          schema:
            type: integer
          example: 1
