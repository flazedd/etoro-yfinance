...
````yaml /api-reference/openapi.json put /api/v1/posts/{postId}/comments/{commentId}/replies/{replyId}
openapi: 3.0.1
info:
  title: eToro Api
  version: v1.279.0
    ...
    put:
      ...
      description: >-
        **Rate limit:** 60 requests per 60 seconds. This is the **default shared
        ...
        Edits the authenticated user's own reply in-place. Same semantics as
        updating a comment.
      operationId: putPostsByPostIdCommentsByCommentIdRepliesByReplyId
      parameters:
        - name: x-request-id
          in: header
          required: true
          schema:
            type: string
            format: uuid
            example: efb63e66-696b-4d3f-8da6-8232f2f3f359
      ...
      responses:
        ...
        '403':
          description: Requester is not the reply owner
        '404':
