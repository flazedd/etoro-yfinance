...
````yaml /api-reference/openapi.json post /api/v1/posts/{postId}/comments
openapi: 3.0.1
info:
  title: eToro Api
  version: v1.279.0
    ...
    post:
      ...
      description: >-
        **Rate limit:** 60 requests per 60 seconds. This is the **default shared
        ...
        Creates a new comment on a specific discussion post. Comments can
        include text, mentions, tags, and attachments.
      ...
      parameters:
        - name: x-request-id
          ...
          schema:
            type: string
            format: uuid
            example: e1ed2799-3cad-4423-8eb7-e6321c912673
        ...
        - name: postId
          in: path
          description: ID of the post to comment on (UUID)
          required: true
          schema:
            type: string
            format: uuid
      ...
      requestBody:
        description: >-
          Comment creation details. `message` is required; `attachments` is
          optional.
        required: true
        content:
          application/json:
