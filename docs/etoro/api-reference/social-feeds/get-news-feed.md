...
Returns a ranked news feed for the authenticated user. Ranking method is resolved via A/B experiment and a configurable default.



## OpenAPI

````yaml /api-reference/openapi.json get /api/v1/feeds/news
openapi: 3.0.1
info:
  title: eToro Api
  version: v1.279.0
    ...
    get:
      ...
      description: >-
        **Rate limit:** 60 requests per 60 seconds. This is a **shared quota** —
        ...
        Returns a ranked news feed for the authenticated user. Ranking method is
        resolved via A/B experiment and a configurable default.
      operationId: getFeedsNews
      parameters:
        - name: x-request-id
          in: header
          required: true
          schema:
            type: string
            format: uuid
            example: 6c153a16-afb9-4ef7-95d1-3701c72a282d
