    ...
    post:
      ...
      description: >-
        **Rate limit:** 20 requests per 60 seconds. This is a **dedicated**
        ...
        [DEPRECATED — use POST /api/v1/posts instead] Creates a new discussion
        post in the feed system. This endpoint allows users to create posts that
        can be associated with instruments, users, or general discussions.
      operationId: postFeedsPost
      parameters:
        - name: x-request-id
          in: header
          required: true
          schema:
            type: string
            format: uuid
            example: 43ce76cc-1d52-4740-90c9-ae6475915bfe
