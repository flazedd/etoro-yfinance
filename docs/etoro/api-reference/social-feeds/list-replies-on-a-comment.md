...
Returns a paginated list of replies nested under a specific comment. Authentication is optional.



## OpenAPI

````yaml /api-reference/openapi.json get /api/v1/posts/{postId}/comments/{commentId}/replies
openapi: 3.0.1
info:
  title: eToro Api
  version: v1.279.0
    ...
    get:
      ...
      description: >-
        **Rate limit:** 60 requests per 60 seconds. This is the **default shared
        ...
        Returns a paginated list of replies nested under a specific comment.
        Authentication is optional.
      operationId: getPostsByPostIdCommentsByCommentIdReplies
      parameters:
        - name: x-request-id
          in: header
          required: true
          schema:
            type: string
            format: uuid
            example: 54d2271f-eb19-4853-a5c4-9e3fb115f2e4
