...
Retrieves a single discussion post by its ID, including comments preview, emotions data, and requester context. Authentication is optional — unauthenticated requests receive the post without personalised requester context.



## OpenAPI

````yaml /api-reference/openapi.json get /api/v1/posts/{postId}
openapi: 3.0.1
info:
  title: eToro Api
  version: v1.279.0
    ...
    get:
      ...
      description: >-
        **Rate limit:** 60 requests per 60 seconds. This is the **default shared
        ...
        Retrieves a single discussion post by its ID, including comments
        preview, emotions data, and requester context. Authentication is
        optional — unauthenticated requests receive the post without
        personalised requester context.
      ...
      parameters:
        - name: x-request-id
          ...
          schema:
            type: string
            format: uuid
            example: aaca1e85-b93f-4b9b-8a46-8e8a8132e21e
        ...
        - name: postId
          in: path
          description: ID of the post to retrieve (UUID)
          required: true
          schema:
            type: string
            format: uuid
        ...
        - name: take
          in: query
          description: Number of inline comments to include in the response
          schema:
            type: integer
            format: int32
            default: 10
        ...
        - name: badgesExperimentIsEnabled
          in: query
          description: Flag indicating whether to include user badges in the response
          schema:
            type: boolean
            default: false
      responses:
