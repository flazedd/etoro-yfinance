...
````yaml /api-reference/openapi.json get /api/v1/posts/{postId}/comments
openapi: 3.0.1
info:
  title: eToro Api
  version: v1.279.0
    ...
    get:
      ...
      description: >-
        **Rate limit:** 60 requests per 60 seconds. This is the **default shared
        ...
        Returns a paginated list of top-level comments on a post. Soft-deleted
        comments are included with isDeleted=true and blanked content so reply
        trees remain navigable. Authentication is optional — unauthenticated
        requests omit requesterContext.
      ...
      parameters:
        - name: x-request-id
          ...
          schema:
            type: string
            format: uuid
            example: 5a7a8b25-d20e-4e19-a8a2-c8215432ce7f
        ...
        - name: offsetEntityId
          in: query
          description: Opaque cursor from previous response for stable paging
          schema:
            type: string
...
components:
  schemas:
    CommentsResponse:
      type: object
      description: Paginated list of comments or replies on a parent entity
      properties:
        reactionPaging:
          type: object
          ...
          properties:
            totalCount:
              type: integer
              description: Total number of comments/replies
              example: 42
            offsetEntityId:
              type: string
            ...
            next:
              ...
              example: >-
                /api/v1/reactions/3fa85f64-5717-4562-b3fc-2c963f66afa6/comments?take=20&offsetEntityId=7c9e6679-7425-40de-944b-e07fc1f90ae7
        comments:
          type: array
          description: List of comment/reply items
          items:
