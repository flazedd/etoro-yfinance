...
Returns a chronological feed of posts from users the authenticated user follows. Requires authentication.



## OpenAPI

````yaml /api-reference/openapi.json get /api/v1/feeds/following
openapi: 3.0.1
info:
  title: eToro Api
  version: v1.279.0
    ...
    get:
      ...
      description: >-
        **Rate limit:** 60 requests per 60 seconds. This is a **shared quota** —
        ...
        Returns a chronological feed of posts from users the authenticated user
        follows. Requires authentication.
      operationId: getFeedsFollowing
      parameters:
        - name: x-request-id
          in: header
          required: true
          schema:
            type: string
            format: uuid
            example: fea6b6ca-db19-4b39-a008-8faa849609ad
