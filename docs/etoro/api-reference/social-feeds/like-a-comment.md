...
Toggles a Like emotion on the specified comment for the authenticated user. emotionType defaults to Like (the only supported emotion type). The call is idempotent — liking an already-liked entity succeeds silently.



## OpenAPI

````yaml /api-reference/openapi.json post /api/v1/posts/{postId}/comments/{commentId}/likes
openapi: 3.0.1
info:
  title: eToro Api
  version: v1.279.0
    ...
    post:
      ...
      description: >-
        **Rate limit:** 60 requests per 60 seconds. This is the **default shared
        ...
        Toggles a Like emotion on the specified comment for the authenticated
        ...
        silently.
      operationId: postPostsByPostIdCommentsByCommentIdLikes
      parameters:
        - name: x-request-id
          in: header
          required: true
          schema:
            type: string
            format: uuid
            example: ee5f31dd-ab50-499c-b4b3-cc5ffa68df37
