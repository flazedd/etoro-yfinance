...
[DEPRECATED — use GET /api/v1/feeds/markets/{marketId} instead] Retrieves feed posts associated with a specific financial instrument. The feed includes discussions, analyses, and other content related to the instrument.
    ...
    get:
      ...
      description: >-
        **Rate limit:** 60 requests per 60 seconds. This is a **shared quota** —
        ...
        [DEPRECATED — use GET /api/v1/feeds/markets/{marketId} instead]
        ...
        the instrument.
      operationId: getFeedsInstrumentByMarketId
      parameters:
        - name: x-request-id
          in: header
          required: true
          schema:
            type: string
            format: uuid
            example: 3888c3a6-e2ee-460b-99e8-8fc6228cfd3b
