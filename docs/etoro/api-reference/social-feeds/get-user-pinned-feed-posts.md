...
````yaml /api-reference/openapi.json get /api/v1/feeds/users/{userId}/pinned
openapi: 3.0.1
info:
  title: eToro Api
  version: v1.279.0
    ...
    get:
      ...
      description: >-
        **Rate limit:** 60 requests per 60 seconds. This is a **shared quota** —
        ...
        Retrieves the posts that the specified user has pinned to the top of
        their profile feed. The pinned feed surfaces highlighted content the
        user has explicitly chosen to feature, ordered by pin time.
      operationId: getFeedsUsersByUserIdPinned
      parameters:
        - name: x-request-id
          in: header
          required: true
          schema:
            type: string
            format: uuid
            example: 8a657449-ab71-44b3-87b7-3c4b9bfb9eba
