...
````yaml /api-reference/openapi.json get /api/v1/watchlists/public/{userId}
openapi: 3.0.1
info:
  title: eToro Api
  version: v1.279.0
    ...
    get:
      ...
      description: >-
        **Rate limit:** 60 requests per 60 seconds. This is a **shared quota** —
        ...
        Retrieves all public watchlists for a specific user.
      operationId: getWatchlistsPublicByUserId
      parameters:
        - name: x-request-id
          in: header
          required: true
          schema:
            type: string
            format: uuid
            example: dcc7a215-2543-4b22-8c75-429318091124
        ...
        - name: userId
          in: path
          description: User ID whose public watchlists to retrieve
          required: true
          schema:
            type: integer
            format: int32
        ...
        - name: itemsPerPageForSingle
          in: query
          description: Number of items per watchlist
          schema:
            type: integer
            format: int32
            default: 100
      ...
      responses:
        '200':
          description: Successfully retrieved public watchlists
          content:
            application/json:
              schema:
