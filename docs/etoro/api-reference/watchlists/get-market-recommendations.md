...
````yaml /api-reference/openapi.json get /api/v1/market-recommendations/{itemsCount}
openapi: 3.0.1
info:
  title: eToro Api
  version: v1.279.0
    ...
    get:
      ...
      description: >-
        **Rate limit:** 60 requests per 60 seconds. This is a **dedicated**
        ...
        Retrieves personalized market recommendations for the authenticated
        user.
      operationId: getMarketRecommendationsByItemsCount
      parameters:
        - name: x-request-id
          in: header
          required: true
          schema:
            type: string
            format: uuid
            example: 7d13ba35-4ab6-4f76-a61a-aca95388533b
      ...
      responses:
        '200':
          description: Successfully retrieved market recommendations
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/MarketRecommendationsResponse'
          headers:
            RateLimit-Limit:
              description: >-
