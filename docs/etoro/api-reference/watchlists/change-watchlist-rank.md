...
Updates the display rank of a watchlist.



## OpenAPI

````yaml /api-reference/openapi.json put /api/v1/watchlists/rank/{watchlistId}
openapi: 3.0.1
info:
  title: eToro Api
  version: v1.279.0
    ...
    put:
      ...
      description: >-
        **Rate limit:** 20 requests per 60 seconds. This is a **shared quota** —
        ...
        Updates the display rank of a watchlist.
      operationId: putWatchlistsRankByWatchlistId
      parameters:
        - name: x-request-id
          in: header
          required: true
          schema:
            type: string
            format: uuid
            example: a21ed56e-4d46-47fb-9733-dc5ba80a2c75
        ...
        - name: newRank
          in: query
          description: New rank position for the watchlist
          required: true
          schema:
            type: integer
            format: int32
      ...
      responses:
        '204':
          description: Watchlist rank updated successfully
          headers:
            RateLimit-Limit:
              description: >-
