...
````yaml /api-reference/openapi.json delete /api/v1/watchlists/{watchlistId}/items
openapi: 3.0.1
info:
  title: eToro Api
  version: v1.279.0
    ...
    delete:
      ...
      description: >-
        **Rate limit:** 20 requests per 60 seconds. This is a **shared quota** —
        ...
        Removes specified items from a watchlist.
      operationId: deleteWatchlistsByWatchlistIdItems
      parameters:
        - name: x-request-id
          in: header
          required: true
          schema:
            type: string
            format: uuid
            example: 53dd4570-cc72-4723-9c1e-b241a7cf31fc
        ...
        - name: watchlistId
          ...
          example: '12345'
      requestBody:
        description: Items to remove from the watchlist
        required: true
        content:
          application/json:
            schema:
