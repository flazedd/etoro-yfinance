...
````yaml /api-reference/openapi.json post /api/v1/watchlists
openapi: 3.0.1
info:
  title: eToro Api
  version: v1.279.0
    ...
    post:
      ...
      description: >-
        **Rate limit:** 20 requests per 60 seconds. This is a **shared quota** —
        ...
        Creates a new watchlist for the authenticated user with the specified
        name and type.
      ...
      parameters:
        - name: x-request-id
          ...
          schema:
            type: string
            format: uuid
            example: ca6d17bf-fb8f-4a87-b4ac-874c680355d5
        ...
        - name: dynamicQuery
          in: query
          description: Dynamic query URL for dynamic watchlists
          schema:
            type: string
      responses:
        '201':
