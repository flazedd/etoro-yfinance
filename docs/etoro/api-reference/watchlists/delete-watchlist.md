...
````yaml /api-reference/openapi.json delete /api/v1/watchlists/{watchlistId}
openapi: 3.0.1
info:
  title: eToro Api
  version: v1.279.0
    ...
    delete:
      ...
      description: >-
        **Rate limit:** 20 requests per 60 seconds. This is a **shared quota** —
        ...
        Removes a watchlist and all its items.
      operationId: deleteWatchlistsByWatchlistId
      parameters:
        - name: x-request-id
          in: header
          required: true
          schema:
            type: string
            format: uuid
            example: b3acb01d-0378-46e2-861c-0a4c0e8f92e1
        ...
        - name: watchlistId
          in: path
          description: Unique identifier of the watchlist to delete
          required: true
          schema:
            type: string
          example: '12345'
