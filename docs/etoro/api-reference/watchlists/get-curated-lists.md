...
````yaml /api-reference/openapi.json get /api/v1/curated-lists
openapi: 3.0.1
info:
  title: eToro Api
  version: v1.279.0
...
paths:
  /api/v1/curated-lists:
    get:
      ...
      parameters:
        - name: x-request-id
          ...
          schema:
            type: string
            format: uuid
            example: 61195b86-854b-4f84-ba64-d874b8d34df7
      ...
      responses:
        '200':
          description: Successfully retrieved curated lists
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/CuratedListsResponse'
          headers:
            RateLimit-Limit:
              description: >-
            ...
            RateLimit-Policy:
              ...
              example: 60;w=60
        '204':
          description: No curated lists available
          headers:
            RateLimit-Limit:
              description: >-
                Maximum number of requests allowed per window. This limit is
