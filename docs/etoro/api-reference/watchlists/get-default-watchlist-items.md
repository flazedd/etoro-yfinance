...
````yaml /api-reference/openapi.json get /api/v1/watchlists/default-watchlists/items
openapi: 3.0.1
info:
  title: eToro Api
  version: v1.279.0
    ...
    get:
      ...
      description: >-
        **Rate limit:** 60 requests per 60 seconds. This is a **shared quota** —
        ...
        Retrieves items from user's default watchlists with optional pagination.
      operationId: getWatchlistsDefaultWatchlistsItems
      parameters:
        - name: x-request-id
          in: header
          required: true
          schema:
            type: string
            format: uuid
            example: 7a92ea5c-667c-4d1f-bae6-b52c5d9a0d60
      ...
      responses:
        '200':
          description: Successfully retrieved default watchlist items
          content:
            application/json:
              schema:
                type: array
