...
Sets the specified watchlist as the user's default watchlist.



## OpenAPI

````yaml /api-reference/openapi.json put /api/v1/watchlists/setUserSelectedUserDefault/{watchlistId}
openapi: 3.0.1
info:
  title: eToro Api
  version: v1.279.0
    ...
    put:
      ...
      description: >-
        **Rate limit:** 20 requests per 60 seconds. This is a **shared quota** —
        ...
        Sets the specified watchlist as the user's default watchlist.
      operationId: putWatchlistsSetUserSelectedUserDefaultByWatchlistId
      parameters:
        - name: x-request-id
          in: header
          required: true
          schema:
            type: string
            format: uuid
            example: a6aed7c0-2df3-4965-945b-43a53c8cc806
        ...
        - name: watchlistId
          in: path
          description: Unique identifier of the watchlist to set as default
          required: true
          schema:
            type: string
          example: '12345'
