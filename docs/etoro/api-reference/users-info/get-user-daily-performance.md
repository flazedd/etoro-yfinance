...
paths:
  /api/v1/user-info/people/{username}/daily-gain:
    get:
      tags:
        - Users Info
      summary: Get user daily performance
      description: >-
        **Rate limit:** 60 requests per 60 seconds. This is the **default shared
        ...
        requirements.
      operationId: getUserInfoPeopleByUsernameDailyGain
      parameters:
        - name: x-request-id
          in: header
          required: true
          schema:
            type: string
            format: uuid
            example: a1439bde-fc6c-4303-8d55-407159effe76
