...
paths:
  /api/v1/instruments/discover:
    get:
      ...
      operationId: getInstrumentsDiscover
      parameters:
        - name: x-request-id
          in: header
          required: true
          schema:
            type: string
            format: uuid
            example: 64dd7ce7-351a-48f1-bcd2-af14f0edb7f0
      ...
      responses:
        '200':
          ...
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/AssetExplorer_InstrumentSearchResponse'
          headers:
            RateLimit-Limit:
              description: >-
...
components:
  schemas:
    AssetExplorer_InstrumentSearchResponse:
      type: object
      description: A paginated set of instruments.
      properties:
        page:
          type: integer
          format: int32
        ...
        totalItems:
          type: integer
          format: int32
          description: The total number of instruments matching the query.
        lastUpdateTime:
          type: string
          format: date-time
          description: Timestamp at which the underlying asset data was last refreshed.
          nullable: true
        items:
          type: array
          description: The instruments on the current page.
          items:
