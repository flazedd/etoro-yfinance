...
````yaml /api-reference/openapi.json get /api/v1/market-data/instrument-types
openapi: 3.0.1
info:
  title: eToro Api
  version: v1.279.0
      ...
      parameters:
        - name: x-request-id
          ...
          schema:
            type: string
            format: uuid
            example: 694642e4-ee9e-4f63-8a55-e84dbeeb8d1b
        ...
        - name: instrumentTypeIds
          in: query
          description: A comma seperated list of instrument type ids to retrieve
          style: form
          explode: false
          schema:
            type: array
      ...
      responses:
        '200':
          ...
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/InstrumentTypesResponse'
          headers:
            RateLimit-Limit:
              description: >-
