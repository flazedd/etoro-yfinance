...
````yaml /api-reference/openapi.json get /api/v1/market-data/stocks-industries
openapi: 3.0.1
info:
  title: eToro Api
  version: v1.279.0
      ...
      parameters:
        - name: x-request-id
          ...
          schema:
            type: string
            format: uuid
            example: 93514b90-d29e-4b8d-a67e-c2c44e214f2c
        ...
        - name: stocksIndustryIds
          in: query
          description: A comma seperated list of stock industry ids to retrieves
          style: form
          explode: false
          schema:
            type: array
      ...
      responses:
        '200':
          ...
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/StocksIndustriesResponse'
          headers:
            RateLimit-Limit:
              description: >-
