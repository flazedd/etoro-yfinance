...
Permanently revokes the specified user token from a agent-portfolio.



## OpenAPI

````yaml /api-reference/openapi.json delete /api/v1/agent-portfolios/{agentPortfolioId}/user-tokens/{userTokenId}
openapi: 3.0.1
info:
  title: eToro Api
  version: v1.279.0
      ...
      parameters:
        - name: x-request-id
          ...
          schema:
            type: string
            format: uuid
            example: 57d05c8a-a3cc-483b-a863-7169bf931fc5
        ...
        - name: userTokenId
          ...
          schema:
            type: string
            format: uuid
          description: The unique identifier of the user token to delete.
      responses:
        '204':
          description: User token revoked successfully
          headers:
            RateLimit-Limit:
              description: >-
          ...
          content:
            application/json:
              ...
              example:
                ...
                errorMessage: Invalid agent-portfolio ID or user token ID
        '401':
