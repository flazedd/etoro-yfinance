...
````yaml /api-reference/openapi.json get /api/v1/agent-portfolios
openapi: 3.0.1
info:
  title: eToro Api
  version: v1.279.0
...
paths:
  /api/v1/agent-portfolios:
    get:
      ...
      parameters:
        - name: x-request-id
          ...
          schema:
            type: string
            format: uuid
            example: 1ad2669b-7fb8-4c92-a037-dad6f32fbf5c
      ...
      responses:
        '200':
          description: Agent-portfolios retrieved successfully
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/GetAgentPortfoliosResponse'
          headers:
            RateLimit-Limit:
              description: >-
  ...
  schemas:
    ...
    AgentPortfolioItem:
      ...
      properties:
        ...
        agentPortfolioName:
          type: string
          description: The display name of the agent-portfolio.
          example: MyPort1
        agentPortfolioGcid:
          type: integer
        ...
        createdAt:
          type: string
          format: date-time
          description: When this agent-portfolio was created.
          example: '2026-03-01T10:30:00+00:00'
        userTokens:
          type: array
          items:
            $ref: '#/components/schemas/AgentPortfolioUserTokenItem'
          description: The user tokens associated with this agent-portfolio.
