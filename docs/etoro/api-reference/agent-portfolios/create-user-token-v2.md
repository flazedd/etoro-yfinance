...
````yaml /api-reference/openapi.json post /api/v2/agent-portfolios/{agentPortfolioId}/user-tokens
openapi: 3.0.1
info:
  title: eToro Api
  version: v1.279.0
...
tags:
  ...
  - name: Deprecated
paths:
  /api/v2/agent-portfolios/{agentPortfolioId}/user-tokens:
    post:
      tags:
        - Agent Portfolios
      summary: Create User Token (v2)
      description: >-
        **Rate limit:** 60 requests per 60 seconds. This is the **default shared
        ...
        Creates a new user token for the specified agent-portfolio using scope
        names. Scopes are specified by name (scopeNames); scope ids are not
        supported in v2.
      operationId: createAgentPortfolioUserTokenV2
      parameters:
        - name: x-request-id
          in: header
          required: true
          schema:
            type: string
            format: uuid
            example: 2c571dd3-ee2c-4c1c-8c5f-c9a3fe86a340
      ...
      requestBody:
        ...
        content:
          application/json:
            schema:
              $ref: '#/components/schemas/CreateUserTokenV2Request'
      responses:
        '201':
        ...
        '400':
          ...
          content:
            application/json:
              ...
              examples:
                ScopeNamesRequired:
                  summary: Scope names are required
                  value:
                    errorCode: ScopeIdsRequired
                    errorMessage: ScopeNames is required
        '401':
      ...
      properties:
        ...
        scopeNames:
          ...
          items:
            type: string
          description: >-
            The set of permission scope names to grant to this token. Available
