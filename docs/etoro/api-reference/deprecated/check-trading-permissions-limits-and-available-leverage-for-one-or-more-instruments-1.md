...
````yaml /api-reference/openapi.json post /api/v1/trading/info/eligibility
openapi: 3.0.1
info:
  title: eToro Api
  version: v1.279.0
...
tags:
  ...
  - name: Deprecated
paths:
  /api/v1/trading/info/eligibility:
    post:
      tags:
        - Deprecated
      summary: >-
      ...
      operationId: getInstrumentEligibilityDeprecated
      parameters:
        - name: x-request-id
          in: header
          required: true
          schema:
            type: string
            format: uuid
            example: b8990cdd-54f3-4a3b-89c1-7a9486f6fdc9
