...
````yaml /api-reference/openapi.json patch /api/v1/price-alerts/{alertId}
openapi: 3.0.1
info:
  title: eToro Api
  version: v1.279.0
    ...
    patch:
      ...
      description: >-
        **Rate limit:** 60 requests per 60 seconds. This is the **default shared
        ...
        Updates the target price of an existing price alert.
      operationId: patchPriceAlertsByAlertId
      parameters:
        - name: x-request-id
          in: header
          required: true
          schema:
            type: string
            format: uuid
            example: c18e45fa-95b8-4f1a-94f1-15e30924aa18
      ...
      responses:
        ...
        '400':
          description: >-
            Invalid request parameters (e.g. invalid alertId format, missing
            targetPrice)
          content:
            application/json:
              schema:
