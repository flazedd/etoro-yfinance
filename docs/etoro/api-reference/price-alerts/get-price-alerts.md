...
Returns all active price alerts for the authenticated user.



## OpenAPI

````yaml /api-reference/openapi.json get /api/v1/price-alerts
openapi: 3.0.1
info:
  title: eToro Api
  version: v1.279.0
...
paths:
  /api/v1/price-alerts:
    get:
      ...
      parameters:
        - name: x-request-id
          ...
          schema:
            type: string
            format: uuid
            example: 28d821c3-c968-477c-87f0-63473bf8b110
      ...
      security:
        - oauth2:
            - etoro-public:price-alerts:read
components:
  schemas:
